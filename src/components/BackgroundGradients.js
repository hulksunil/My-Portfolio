...
const BackgroundGradients = () => {
    return (
        <div className="absolute inset-0 -z-10 bg-slate-50 dark:bg-[#020617] transition-colors duration-500 overflow-hidden translate-z-0">
            ...
            <div className="absolute top-1/4 -left-20 w-[600px] h-[600px] bg-[#0ea5e9]/10 dark:bg-[#0ea5e9]/15 rounded-full blur-[80px] animate-pulse-slow will-change-transform">
                <div className="absolute inset-0 bg-[#0ea5e9]/5 dark:bg-[#0ea5e9]/10 rounded-full animate-drift will-change-transform"></div>
            </div>
            <div className="absolute bottom-1/4 -right-20 w-[600px] h-[600px] bg-teal-500/10 dark:bg-teal-500/15 rounded-full blur-[80px] animate-pulse-slow will-change-transform" style={{ animationDelay: '2s' }}>
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-[#0ea5e9]/5 rounded-full blur-[100px]"></div>
        </div>
    );
};
